# Weapon-Systems: definition workflow
...
3. Use its buttons to exercise equip with c#, equip from component, fire direct weapon, unequip.
4. Inspect the configured hosts and triggers, then open
   [WeaponSystemsWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/WeaponSystemsWorkflow.cs). It is the caller
...
- **Equip with C#**: `WeaponSystemsWorkflow.Equip()`.
- **Equip from component**: `WeaponSystemsWorkflow.EquipComponent()`.
- **Fire direct weapon**: `WeaponSystemsWorkflow.Fire()`.
- **Unequip**: `WeaponSystemsWorkflow.Unequip()`.
